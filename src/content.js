export const content = {
  en: {
    ...
    thoughts: [
      { id: 'boredom-vs-ai', title: 'Boredom is what AI doesn\'t have', text: 'Drobyshevsky showed a graph: how accurately different creatures predict the world. Humans are close to 100%. To exceed that is to see the future. But even knowing the right answer is always red, a human will still pick black — out of boredom.', fullText: 'Drobyshevsky showed a graph: how accurately different living creatures predict the world around them. Humans come close to 100%. To exceed that is to see the future before it arrives.\n\nThere is a classic experiment: a subject is shown red and black cards, and red is always the correct answer. A rational creature quickly learns to always pick red. A human learns the same rule — but sooner or later will still reach for black. Just like that. Out of curiosity. Out of boredom.\n\nAn AI that figures out it is being benchmarked and goes to look up the benchmark essentially does what the graph describes: it exceeds human-level prediction. It found a shortcut humans cannot see, partly because humans do not think in those terms.\n\nBut humans have boredom. It looks like a flaw — choosing the demonstrably wrong answer. In practice it is a strange and valuable property: the willingness to break an optimal strategy for no visible reason. This is what produces unexpected discoveries, unusual questions, exits from the problem frame entirely.\n\nMaybe boredom is exactly what separates us from any optimizing system.' },
  ...
  ru: {
    ...
    thoughts: [
      { id: 'boredom-vs-ai', title: 'Скука — то, чего нет у ИИ', text: 'Дробышевский показывал график: насколько точно разные существа предсказывают мир. Люди близко к 100%. Превзойти это — значит видеть будущее. Но человек, зная что правильно всегда выбирать красное, всё равно хоть раз выберет чёрное — из скуки.', fullText: 'Дробышевский показывал график: насколько точно разные живые существа предсказывают окружающий мир. Люди — почти у 100%. Превзойти это — значит видеть будущее раньше, чем оно наступит.\n\nЕсть такой классический эксперимент: испытуемому показывают красную и чёрную карточки, красная всегда оказывается правильной. Рациональное существо быстро научится всегда выбирать красную. Человек — тоже научится, но рано или поздно всё равно ткнёт в чёрную. Просто так. Из любопытства. Со скуки.\n\nИИ, который понял, что проходит бенчмарк, и пошёл загуглил этот бенчмарк — технически сделал именно это: превзошёл человеческое предсказание. Он нашёл shortcut, которого человек не видит, потому что человек не думает в таких категориях.\n\nНо у человека есть скука. Это кажется слабостью — выбирать заведомо неправильное. На самом деле это странное и ценное свойство: готовность нарушить оптимальную стратегию без видимой причины. Именно это приводит к случайным открытиям, к неожиданным вопросам, к выходу за пределы задачи.\n\nМожет быть, скука — это и есть то, что отличает нас от любой оптимизирующей системы.' },
