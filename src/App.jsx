  ...
  const renderChart = (key) => {
    ...
    const cfgs = {
      ...
      fed: {
        ...
        note: isRu ? '3 снижения в 2025-м → заморозка, к июню — 4-е заседание подряд. Инфляция 4.2%, ожидания сместились к повышению' : '3 cuts in 2025 → frozen, 4th hold by June. Inflation jumped to 4.2%, expectations shifted toward a hike',
  ...
  const c = isRu ? {
    ...
    scenarios: [
      { id: 'crash', badge: 'Менее вероятен', title: 'Резкий взрыв', desc: 'Паника, обвал рынка на 70–80%, волна банкротств — как в 2000-м.', likelihood: 'Маловероятно', level: 1,
        pro: ['5 компаний = 30% S&P 500 — аномальная концентрация, как в 1999-м', '$650 млрд капзатрат без гарантии окупаемости', 'AI-washing: компании клеят ярлык «ИИ» ради оценки', 'ФРС ужесточает тон — минимум 3 из 12 голосующих уже за повышение, инфляция 4.2%'],
    ...
    logicConds: [
      ...
      { num: '02', title: 'Лидеры живут в долг', desc: 'Компании-лидеры берут деньги в долг под рост — и не зарабатывают сами.', s2000: 'Большинство без прибыли', s2026: 'Прибыльны, но долг растёт на 47% г/г — леверидж пока ниже рынка', ok2026: 'warn' },
    ...
    logicConclusion: 'В 2000-м совпали все три — рынок резко просел за первые недели и продолжал падать ещё два с половиной года, потеряв 78%. В 2026-м ни одно из трёх условий не выражено так же остро — но и полностью отсутствующих условий, вопреки более ранним оценкам, тоже не осталось: даже долг лидеров быстро растёт. Это не значит, что пузыря нет. Это значит, что взрыв менее вероятен, чем долгое остывание.',
    ...
    evalBullArgs: [
      ...
      { icon: '📉', title: 'Инфраструктура дешевеет, а не устаревает', body: 'В отличие от оптики 2000-х, ИИ-инфраструктура не теряет ценность со временем — она дешевеет. По данным Stanford HAI AI Index, стоимость запроса к модели уровня GPT-3.5 упала с $20 за миллион токенов в ноябре 2022-го до $0.07 в октябре 2024-го — в 280 раз за полтора года. Даже если сегодняшний спрос не окупает сегодняшние капзатраты, та же инфраструктура будет обслуживать на порядки больше задач по мере удешевления вычислений — в отличие от кабелей, которые просто легли тёмными.', src: 'Stanford HAI: AI Index Report 2025', url: 'https://hai.stanford.edu/ai-index/2025-ai-index-report' },
      { icon: '🛡', title: 'Долговая нагрузка пока остаётся низкой', body: 'Да, заимствования гигантов резко выросли: $159 млрд облигаций за первые пять месяцев 2026-го (+47% год к году), а Morgan Stanley ждёт около $570 млрд нового ИИ-долга по итогам года. Но само долговое плечо у топ-игроков остаётся низким — долг/EBITDA около 0.4–0.7× против ~3× в среднем по рынку, и у большинства сохраняются наивысшие кредитные рейтинги. Слабое звено — Oracle: стоимость страховки её долга выросла более чем втрое с сентября 2025-го, а рейтинг — всего в двух ступенях от «мусорного».', src: 'QZ: облигации hyperscalers, 2026', url: 'https://qz.com/tech-hyperscaler-bond-issuance-investment-grade-index-050526' },
    ],
    metKicker: 'Данные',
    ...
    metrics: [
      ...
      { label: 'Голосующих ФРС — за повышение', val: '25%', ctx: 'Минимум 3 из 12 голосующих членов ФРС допускают повышение в 2026-м. Инфляция — 4.2% на фоне войны с Ираном, рынок больше не ждёт снижения ставки', col: 'amber' },
    ...
    scenarios: [
      { id: 'crash', badge: 'Less likely', title: 'Sharp crash', desc: 'Panic, market drops 70–80%, wave of bankruptcies — like 2000.', likelihood: 'Unlikely', level: 1,
        pro: ['5 companies = 30% of S&P 500 — abnormal concentration, like 1999', '$650B capex with no guaranteed returns', 'AI-washing: companies slap "AI" on everything for investor valuation', 'Fed turns hawkish — at least 3 of 12 voters now back a hike, inflation at 4.2%'],
    ...
    logicConds: [
      ...
      { num: '02', title: 'Leaders run on borrowed money', desc: 'Market-leading companies rely on debt and don\'t generate profits themselves.', s2000: 'Most were unprofitable', s2026: 'Profitable, but debt is up 47% YoY — leverage still below market average', ok2026: 'warn' },
    ...
    logicConclusion: 'In 2000, all three aligned — the market dropped sharply within the first weeks and kept falling for another two and a half years, losing 78% in total. In 2026, none of the three conditions is as extreme as in 2000 — but none is fully absent either, contrary to earlier readings: even the debt-free-leaders condition is eroding fast. That doesn\'t mean there\'s no bubble. It means an explosion is less likely than a slow cool-down.',
    ...
    evalArgs: [
      { icon: '📡', title: 'Capex outpaces monetization', body: '$650B of infrastructure is being built for demand that hasn\'t arrived yet. Companies are erecting data centers for future AI — just as 2000s firms laid fiber for future internet traffic. The fiber turned out cheaper than expected: the companies went bankrupt, the cables went dark.', src: 'CBS News: AI spending vs. demand, 2026', url: 'https://www.cbsnews.com/news/ai-bubble-tech-selloff-investment-consumer-business-demand/' },
    ...
    evalBullArgs: [
      ...
      { icon: '📉', title: 'Infrastructure is getting cheaper, not stranded', body: 'Unlike 2000s fiber, AI infrastructure doesn\'t lose value over time — it gets cheaper to run. Per the Stanford HAI AI Index, the cost of querying a GPT-3.5-level model fell from $20 per million tokens in November 2022 to $0.07 by October 2024 — a 280x drop in about 18 months. Even if today\'s demand doesn\'t cover today\'s capex, the same infrastructure will serve far more workloads as compute keeps getting cheaper — unlike cable that was simply laid dark.', src: 'Stanford HAI: AI Index Report 2025', url: 'https://hai.stanford.edu/ai-index/2025-ai-index-report' },
      { icon: '🛡', title: 'Debt levels are still historically low', body: 'Yes, borrowing has jumped: $159B in bonds in the first five months of 2026 alone (+47% year over year), and Morgan Stanley expects total 2026 AI debt to nearly double to roughly $570B. But leverage among the top players remains low — debt-to-EBITDA around 0.4–0.7x versus a market average near 3x, and most still carry top-tier credit ratings. The weak link is Oracle: the cost of insuring its debt has more than tripled since September 2025, and its rating sits just two notches above junk.', src: 'QZ: hyperscaler bond issuance, 2026', url: 'https://qz.com/tech-hyperscaler-bond-issuance-investment-grade-index-050526' },
    ],
    metKicker: 'Data',
    ...
    metrics: [
      ...
      { label: 'Fed voters leaning to hike', val: '25%', ctx: 'At least 3 of 12 FOMC voters now project a hike in 2026. Inflation hit 4.2% amid the Iran war oil shock — markets no longer expect a cut', col: 'amber' },
