export const dictionary = {
  en: {
    ...
    metricRepos: 'repos', metricCuriosity: 'curiosity',
  ...
  ru: {
    ...
    identityLabel: 'runtime', identityValue: 'джентльмен',
    metricRepos: 'репо', metricCuriosity: 'любопытство',
