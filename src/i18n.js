export const dictionary = {
  ...
  ru: {
    ...
    feedEyebrow: 'Лента', feedTitle: 'Заметки, фрагменты и вещи, к которым хочется вернуться.', feedLead: 'Спокойный поток публичных заметок, эссе, фрагментов проектов и наблюдений. Если идея окажется полезной — используйте её в своей жизни, работе или проектах.', feedSubscribe: 'Подписаться',
