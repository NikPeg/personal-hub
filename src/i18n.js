export const dictionary = {
  en: {
    ...
    recent: 'recent', upvotes: 'upvotes', draft: 'draft', seed: 'seed', sortBy: 'Sort by', allTags: 'All', filterByTag: 'Filter by tag', loading: 'Loading thoughts…', showMore: 'Show more', open: 'Open →', openLanding: 'Open landing →', backToProjects: 'Back to projects', images: 'images', close: 'Close', note: 'note',
  ...
  ru: {
    ...
    recent: 'новизне', upvotes: 'апвоутам', draft: 'черновик', seed: 'зерно', sortBy: 'Сортировать по', allTags: 'Все', filterByTag: 'Тег', loading: 'Загружаю мысли…', showMore: 'Показать ещё', open: 'Открыть →', openLanding: 'Открыть лендинг →', backToProjects: 'Назад к проектам', images: 'изображения', close: 'Закрыть', note: 'заметка',
