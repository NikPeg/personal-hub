export const dictionary = {
  en: {
    ...
    feedEyebrow: 'Feed', feedTitle: 'Notes, fragments, and things worth returning to.', feedLead: 'A quieter stream of public notes, essays, project fragments, and observations — take whatever is useful for your own work.', feedSubscribe: 'Subscribe',
    ...
    channelsEyebrow: 'Contact', channelsTitle: 'NikPeg contacts and channels.', channelsLead: 'Direct contacts first, then public feeds, personal shelves, books, and profiles.',
    projectsEyebrow: 'Projects', projectsTitle: 'Projects', projectsLead: 'A compact index of things NikPeg is building or sketching. Open a project to see its landing page.',
  ...
  ru: {
    ...
    feedEyebrow: 'Лента', feedTitle: 'Заметки, эссе и вещи, к которым хочется вернуться.', feedLead: 'Спокойный поток публичных заметок, эссе, проектных набросков и наблюдений. Если идея окажется полезной — используйте её в своей жизни, работе или проектах.', feedSubscribe: 'Подписаться',
    ...
    channelsEyebrow: 'Контакты', channelsTitle: 'Контакты и каналы НикПега.', channelsLead: 'Сначала прямые контакты, затем публичные каналы, личные полки, книги и профили.',
    projectsEyebrow: 'Проекты', projectsTitle: 'Проекты', projectsLead: 'Короткий список того, что НикПег строит или набрасывает. Нажми на проект, чтобы открыть его лендинг.',
